...
router.post('/search', async (req, res) => {
  try {
    ...
    if (filters) {
      ...
      if (filters.minFee) searchFilter.tuitionFee = { ...searchFilter.tuitionFee, $gte: filters.minFee };
      if (filters.maxFee) searchFilter.tuitionFee = { ...searchFilter.tuitionFee, $lte: filters.maxFee };
    }
