...
export default function Newsletters() {
   ...
   return (
      <>
         <Helmet>
            <title>Honoured Consult - Newsletter</title>
            <meta
               name="description"
               content="Stay up to date to all our latest news."
               data-rh="true"
            />
               ...
               <div className="relative z-10 max-w-4xl mx-auto text-center">
                  ...
                  >
                     ...
                     <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                        Stay informed with the latest updates, tips, and
                        insights about studying abroad
                     </p>
                  </motion.div>
               </div>
            </section>
                  ...
                  >
                     <Card className="bg-gray-200 border-2 border-gray-300">
                        <CardHeader className="text-center pb-4">
                           ...
                           <CardDescription>
                              Get the latest news, study abroad tips, and
                              exclusive opportunities delivered to your inbox
                           </CardDescription>
                        </CardHeader>
                        <CardContent>
                           {alertMessage && (
