            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
               <div>
                  ...
                  <p className="text-primary-foreground/80 leading-relaxed mb-6">
                     Nigeria's most trusted study abroad consultancy. We help
                     students achieve their international education dreams with
               ...
               <div>
                  ...
                  <div className="mt-6">
                     ...
                     <div className="flex gap-3">
                        <a
                           href="https://www.facebook.com/share/1JLXJyfjbR/"
                           target="_blank"
                           rel="noopener noreferrer"
                           className="w-10 h-10 rounded-lg bg-white/10 hover:bg-accent hover:text-accent-foreground flex items-center justify-center transition-all hover:scale-110"
                        >
                           <FacebookLogo size={20} weight="fill" />
                        </a>
                        <a
                           href="https://www.instagram.com/honoured_consult.to?igsh=MTRiYmV0a3F6MDdhbQ=="
                           target="_blank"
                           rel="noopener noreferrer"
                           className="w-10 h-10 rounded-lg bg-white/10 hover:bg-accent hover:text-accent-foreground flex items-center justify-center transition-all hover:scale-110"
                        >
                        ...
                        <a
                           href="https://www.tiktok.com/@honoured.consult1"
                           target="_blank"
                           rel="noopener noreferrer"
                           className="w-10 h-10 rounded-lg bg-white/10 hover:bg-accent hover:text-accent-foreground flex items-center justify-center transition-all hover:scale-110"
                        >
                        ...
                        <a
                           href="https://x.com/HonouredConsult"
                           target="_blank"
                           rel="noopener noreferrer"
                           className="w-10 h-10 rounded-lg bg-white/10 hover:bg-accent hover:text-accent-foreground flex items-center justify-center transition-all hover:scale-110"
                        >
