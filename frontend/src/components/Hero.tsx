         ...
         <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 py-20 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-8 text-center lg:text-left">
               ...
               >
                  ...
                  <br />
                  <span className="text-foreground">Study Abroad</span> with
                  Confidence
               </motion.h1>
               ...
               >
                  Your trusted partner in international education. Expert
                  counseling, seamless applications, visa support, and
                  preparations. We handle everything so you can focus on your
                  dreams.
               </motion.p>
               ...
               >
                  {[
                     ...
                     <div
                        key={index}
                        className="text-center p-4 rounded-xl bg-card backdrop-blur-sm border border-border/50"
                     >
